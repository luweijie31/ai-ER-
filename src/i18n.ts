export const I18N = {
        zh: {
          ...
          btnImportSQL: "导入 SQL 文件",
          btnAIAnalyze: "AI 分析生成",
          btnAIAnalyzing: "AI 分析中...",
          aiPanelTitle: "AI 智能分析",
          aiKeyLabel: "DeepSeek API Key",
          aiKeyPlaceholder: "sk-...",
          aiKeySave: "保存",
          aiKeySaved: "已保存",
          aiKeyTip: "Key 仅保存在本地浏览器，不会上传",
          aiTip: "将 SQL 发送给 DeepSeek，自动翻译为中文并推断关系基数",
          errAINoKey: "请先填写 DeepSeek API Key",
          errAIFailed: "AI 分析失败：",
...
`,
        ...
        en: {
          ...
          btnImportSQL: "Import SQL",
          btnAIAnalyze: "AI Analyze",
          btnAIAnalyzing: "Analyzing...",
          aiPanelTitle: "AI Analysis",
          aiKeyLabel: "DeepSeek API Key",
          aiKeyPlaceholder: "sk-...",
          aiKeySave: "Save",
          aiKeySaved: "Saved",
          aiKeyTip: "Key is stored locally in your browser only",
          aiTip: "Send SQL to DeepSeek to auto-translate and infer cardinality",
          errAINoKey: "Please enter your DeepSeek API Key first",
          errAIFailed: "AI analysis failed: ",
